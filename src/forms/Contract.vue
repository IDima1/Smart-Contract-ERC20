...
const contractInit = useErc20Contract('0x5a307c8C0198F855266c96DeC43a3429f474291d')
...
const initContractData = async () => {
  if (!storeProvider.provider.address) throw new TypeError('Provider is not defined')

  contractBalance.value = await contractInit.getBalanceOf(storeProvider.provider?.address)
