    ...
    <div class="contract-interaction">
      <div class="contract-interaction__replenishment">
        ...
        <input-field
          ...
          :min-length="LengthValue.MinLengthTransferTokens"
        />
        <app-button
          type="button"
      ...
      <div class="contract-interaction__transfer">
        ...
        <input-field
          ...
          :min-length="LengthValue.MaxLengthTransferTokens"
        ...
        <input-field
          ...
          :label="$t('placeholders.tokens-to-transfer-label')"
          :min-length="LengthValue.MinLengthTransferAddress"
          :max-length="LengthValue.MaxLengthTransferAddress"
...
const { isFormValid, getFieldErrorMessage } = useFormValidation(form, {
  amount: { required, numeric, minLength },
  tokens: { required, numeric, minLength },
...
const transferTokens = async () => {
  try {
    ...
    bus.emit(BUS_EVENTS.success, 'The tokens was succsesfully transfered ')
  } catch (error) {
