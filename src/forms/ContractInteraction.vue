    ...
    <div class="contract-interaction">
      <div class="contract-interaction__replenishment">
        ...
        <input-field
          ...
          :min-length="LENGTH_VALUE.MIN_LENGTH_TOKENS"
        />
        <app-button
          type="button"
      ...
      <div class="contract-interaction__transfer">
        ...
        <input-field
          ...
          :min-length="LENGTH_VALUE.MAX_LENGTH_TOKENS"
        ...
        <input-field
          ...
          :label="$t('placeholders.tokens-to-transfer-label')"
          :min-length="LENGTH_VALUE.MIN_LENGTH_ADDRESS"
          :max-length="LENGTH_VALUE.MAX_LENGTH_ADDRESS"
...
const getContractBalance = computed(() => {
  ...
  const transferTokens = async () => {
    try {
      ...
      bus.emit(
        BUS_EVENTS.success,
        'The tokens was succsesfully transfered ',
      )
    } catch (error) {
